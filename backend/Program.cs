...
string connectionString = "Server=RDS-ENDPOINT;Database=DBNAME IN YOUR SERVER;User Id=admin;Password=ENTER-YOUR-PASSWORD;Encrypt=True;TrustServerCertificate=True;";
